...
**Control Panel for Twitter is a Safari extension for iPhone, iPad and Mac which gives you more control over Twitter and adds missing features and UI improvements**
