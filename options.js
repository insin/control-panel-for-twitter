...
for (let translationId of [
  ...
  'hideVerifiedOrgsNavLabel_desktop',
  ...
  'hideVerifiedOrgsNavLabel_mobile',
  'hideTopicsNavLabel',
...
function exportConfig() {
  ...
  $a.download = 'control-panel-for-twitter-v3.4.4.config.txt'
